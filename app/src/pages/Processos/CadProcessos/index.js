        ...
        if (
          ...
          if (inclui === false) {
            ...
            setHelperErrorsProcesso(
              '*Já existe um segmento com este nome associado a este processo'
            );
          } else {
            setMensagem({
              titulo: 'Sucesso',
        ...
        if (
          ...
          if (inclui === false) {
            ...
            setHelperErrorsImagem(
              '*Já existe uma imagem com este nome associada a este processo'
            );
          } else {
            setMensagem({
              titulo: 'Sucesso',
            ...
            <Grid container justify="flex-start" spacing={2} wrap="wrap">
              ...
              {NovoOuAlteracao[5] != 'CodProces=0' ? (
                <>
                  ...
                  {/* Lista de Segmentos Já Existentes */}
                  ...
                  <Grid container spacing={1} wrap="wrap">
                    ...
                    {/* Botão para Associar Segmento Selecionado ao Processo Definido */}
                  ...
                  {/* Lista de Segmentos Já Associados ao Processo Definido */}
