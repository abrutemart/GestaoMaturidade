      ...
      try {
        ...
        setMensagem({
          ...
          conteudo: deleteGrupo
            ...
            : `Existem perguntas e/ ou processos de empresas associadas a esse grupo de respostas. Não é possível efetuar a exclusão!`,
            ...
            <Table
              ...
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>
                    <div className="tableCellHead">Nº Respostas</div>
                  </TableCell>
                  <TableCell>
                ...
                {(rowsPerPage > 0
                  ...
                  <TableRow key={row.CodGrpRes}>
                    ...
                    <TableCell
                      ...
                      {row.TipoRespo === 1 ? 'Única Escolha' : 'Multipla Escolha'}
                    </TableCell>
                    <TableCell align="right" size="small">
                      <IconButton
                        aria-label="edit"
