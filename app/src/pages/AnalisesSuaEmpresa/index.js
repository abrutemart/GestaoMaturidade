...
export default function ProcEmpresa() {
  ...
  return (
    <Fragment>
      ...
      <PageTitle
        titleHeading="Análises da Sua Empresa"
        titleDescription="Menu"
      />
      <Grid container>
        <Grid item xs={12}>
                  ...
                  <div className={classes.root}>
                    <AppBar position="static">
                      <Tabs
                        ...
                        <Tab label="Análise da Sua Empresa" />
                        <Tab label="Comparativo com o Mercado" />
                      </Tabs>
                    </AppBar>
                          ...
                          <Grid
                            ...
                            <Grid
                              ...
                              <div
                                ...
                                Índice por Processo (Comparativo)
                              </div>
                              <Divider variant="middle" />
                              <br />
                              <Grid
