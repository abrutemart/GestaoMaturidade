...
const buscaVersaoDiagnostico = async CodEmpres => {
  ...
  FROM ProEmpAux WHERE CodEmpres=${CodEmpres}`;
  const result = await Axios.get(process.env.REACT_APP_SRV_PROXY+process.env.REACT_APP_PORTA + '/api/get', {
    params: { query }
  })
    .then(response => {
...
const buscaResposta = async (CodEmpres, CodProces, Versao, CodSegmen) => {
  let query = `SELECT
  ProEmpAux.CodEmpres,
  ProEmpAux.CodProces,
  ProEmpAux.Versao,
...
const buscaRespostaRisco1 = async (CodEmpres, CodProces, Versao, CodSegmen) => {
  let query = `SELECT
  ProEmpAux.CodEmpres,
  ProEmpAux.CodProces,
  ProEmpAux.Versao,
...
const buscaRespostaRisco2 = async (CodEmpres, CodProces, Versao, CodSegmen) => {
